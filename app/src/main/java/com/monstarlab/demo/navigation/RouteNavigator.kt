...
interface RouteNavigator {
    ...
    fun navigateToRoute(route: String, isNewRoute: Boolean = false)
...
class RouteNavigatorImpl : RouteNavigator {
    ...
    override fun navigateToRoute(route: String, isNewRoute: Boolean) =
        navigate(NavigationState.NavigateToRoute(route = route, newRoute = isNewRoute))
